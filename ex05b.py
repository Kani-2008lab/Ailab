...
return clause[0]
return None
defsimplify_clauses(clauses, literal):
    """
...
ifnew_clauses is not None and dpll(new_clauses, assignments + [literal]):
return True
new_clauses = simplify_clauses(clauses, -literal)
ifnew_clauses is not None and dpll(new_clauses, assignments + [-literal]):
return True
